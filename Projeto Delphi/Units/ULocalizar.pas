...
begin
  if (EditOpcao.Font.Color = clRed) or
 ...
 if EditLocalizar.Text <> '' then begin
     Qry_Localizar.SQL.Add(CampoTabela+
      ...
      Qry_Localizar.ParamByName('NOME').AsString :=
       EditLocalizar.Text;
 end else  begin
...
begin
  Qry_Localizar.Close;
  EditOpcao.ItemIndex:=0;//kljdfsklad
end;

procedure TfrmLocalizar.EditOpcaoExit(Sender: TObject);
Var I,J : Integer;
begin
 EditOpcao.Color := clWindow;
