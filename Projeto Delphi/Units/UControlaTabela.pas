...
Try
  ...
  'Você deve reiniciar o Sistema e tentar novamente.',
...
Try
 vQry := TIBQuery.Create(Application);
  ...
  Application.MessageBox(
  'Erro ao tentar criar a Auto-Numeração para o registro!!!'+#13#13+
  'Você deve reiniciar o Sistema e tentar novamente.',
  'Aviso',MB_OK+mb_iconerror );
  application.terminate;
end;
...
try
  ...
  Application.MessageBox(
  'Erro ao tentar colocar o Registro em modo de Edição!!!'+#13#13+
  'Você deve reiniciar o Sistema e tentar novamente.',
  'Aviso',MB_OK+mb_iconerror );
  application.terminate;
end;
